...
class LoginViewController_AutoLayout: UIViewController {
    ...
    private func setUI() {
        [titleLabel, idTextField, passwordTextField, loginButton, loginLabel].forEach {
    ...
    private func setLayout() {
        ...
        NSLayoutConstraint.activate([idTextField.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 71),
                                     idTextField.centerXAnchor.constraint(equalTo: view.centerXAnchor), idTextField.heightAnchor.constraint(equalToConstant: 58),
                                     idTextField.widthAnchor.constraint(equalToConstant: 335)])
        NSLayoutConstraint.activate([passwordTextField.topAnchor.constraint(equalTo:
                                                                                idTextField.bottomAnchor, constant: 6),
                                     passwordTextField.centerXAnchor.constraint(equalTo: view.centerXAnchor), passwordTextField.heightAnchor.constraint(equalToConstant: 58),
