...
protocol WelcomeReloginDelegate: AnyObject { // AnyObject를 붙여서 상속한 프로토콜은 클래스만 채택해서 final과 같이!
...
final class WelcomeViewController_Delegate: UIViewController {
    ...
    private func backToLoginButtonDidTap() {
        delegate?.retryLogin(didTapReloginWith: "다시 로그인 버튼을 눌렀어요!") // 뒤로 가기 누르면 해당 함수 호출
